...
0
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/header.htm', 1393045389, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/pubsearch.htm', 1393045389, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/thread_list.htm', 1393045389, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/search/footer.htm', 1393045389, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
|| checktplrefresh('./template/default/search/forum.htm', './template/default/common/header_common.htm', 1393045389, '1', './data/template/1_1_search_forum.tpl.php', './template/default', 'search/forum')
;?>
...
<em>Powered by <strong>Discuz!</strong> <em><?php echo $_G['setting']['version'];?></em><?php if(!empty($_G['setting']['boardlicensed'])) { ?> <a href="http://license.comsenz.com/?pid=1&amp;host=<?php echo $_SERVER['HTTP_HOST'];?>" target="_blank">Licensed</a><?php } ?></em> &nbsp;
<em>&copy; 2001-<?php echo date('Y');?> Comsenz Inc.</em>
