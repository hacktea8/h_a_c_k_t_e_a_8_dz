...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1393043652, '1', './data/template/1_1_common_header_misc_ranklist.tpl.php', './template/default', 'common/header_misc_ranklist')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1393043652, '1', './data/template/1_1_common_header_misc_ranklist.tpl.php', './template/default', 'common/header_misc_ranklist')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1393043652, '1', './data/template/1_1_common_header_misc_ranklist.tpl.php', './template/default', 'common/header_misc_ranklist')
;?>
